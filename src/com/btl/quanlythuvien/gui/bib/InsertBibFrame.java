...
public class InsertBibFrame extends javax.swing.JFrame {
    ...
    private void reloadUpdate() {
        ...
        jcb_041.setSelectedItem(selectJCombo(marcBean2.getSp041().replace("$$a", ""), list041));
        jcb_925.setSelectedItem(selectJCombo(marcBean2.getTy925(), list925));
        jcb_927.setSelectedItem(selectJCombo(marcBean2.getTy925(), list927));
    }
    ...
    private void reloadInsert() {
        ...
        jtf_245_b.setUI(new HintTextFieldUI("Phần còn lại của nhan đề"));
        jtf_260_a.setUI(new HintTextFieldUI("Nơi xuất bản"));
        jtf_260_b.setUI(new HintTextFieldUI("Nhà sản xuất"));
        jtf_260_c.setUI(new HintTextFieldUI("Năm sản xuất"));
        jtf_300_a.setUI(new HintTextFieldUI("Khối lượng"));
        jtf_300_b.setUI(new HintTextFieldUI("Các đặc điểm khác"));
        jtf_300_c.setUI(new HintTextFieldUI("Kích thước"));
        jtf_650_a.setUI(new HintTextFieldUI("Thuật ngữ chủ đề tiêu đề "));
        jtf_650_v.setUI(new HintTextFieldUI("Đề mục con hình thức, thể loại"));
    }
