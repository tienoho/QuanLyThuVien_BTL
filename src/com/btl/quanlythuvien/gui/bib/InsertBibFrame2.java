 ...
 * @author Admin
 */
public class InsertBibFrame2 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InsertBibFrame2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InsertBibFrame2().setVisible(true);
            }
        });
    }
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (jcb_041.getSelectedIndex() != -1) {
                    data = "Fruits Selected: "
                            + arrFlag[jcb_041.getSelectedIndex()];
                }
